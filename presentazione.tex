					...
					\begin{itemize}
						...
						\item Difetti:
							\begin{itemize}
								...
								\item Può richiedere un blocco della produzione
							\end{itemize}
					\end{itemize}
	...
	\begin{columns}
		\column{0.5\textwidth}
			\begin{itemize}
				...
				\item Il valore è determinato con una Cross Correlation tra l'immagine e il template
...
\begin{itemize}
	...
	\item Si può osservare un falso positivo che è sfuggito ai filtri, a sinistra nell'immagine
\end{itemize}
\vskip 0.5cm
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Non è stato possibile verificare sul campo il livello di precisione dei dati ottenuti
		\end{itemize}
		\column{0.4\textwidth}
